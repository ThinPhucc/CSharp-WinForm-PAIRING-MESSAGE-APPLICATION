...
namespace Client
{
    public partial class GoingMessage : UserControl
    {
        public GoingMessage()
        {
            InitializeComponent();
        ...
        public void DesignMessage(string value)
        {
            ...
            MessageOut.Height = height;
            // Thêm một số thuộc tính phụ cho Label để hiển thị cho đẹp.
            MessageOut.Width = 250;
            MessageOut.AutoSize = false;
            MessageOut.Margin = new Padding(0, 10, 0, 0);
            MessageOut.Text = value;
